...
export const NavbarReact = () => {
    ...
    return (
        <>
            ...
            <nav aria-label="Navigasi utama Naufal Ananta" className="z-50 fixed flex justify-center w-full text-amber-50 font-bold">
                ...
                <button
                    onClick={toggleNav}
                    aria-label={nav ? "Tutup menu navigasi" : "Buka menu navigasi"}
                    className="md:hidden absolute top-5 right-14 border rounded z-50 text-white/50 border-white/70 p-2"
                >
